...
if 'userprofiles.contrib.emailverification' in settings.INSTALLED_APPS:
    ...
    url(r'^settings/$', 'email_change', name='userprofiles_email_change'),
    url(r'^settings/email_change/$', 'email_change_save', name='email_change_save'),
    url(r'^settings/password_change/$', 'password_change_save', name='password_change_save'),

...
def clean_new_password1(value):
        ...
        if len(password1) < 8:
            raise ValidationError(translation.gettext("The password must be at least 8 characters long"))
...
class RegistrationForm(forms.Form):
    ...
    password = forms.CharField(label=_('Password'),
        widget=forms.PasswordInput(render_value=False),validators=[clean_new_password1],
